...
class Bp_UsbFormat(Screen):
    ...
    def __init__(self, session):
        ...
        msg += _('Please be sure that your usb drive is NOT CONNECTED to your Golden Media box before you continue.\n')
    ...
    def stepOne(self):
        msg = _('Connect your usb storage to your Golden Media box\n')
...
class BhSpeedUp(Screen, ConfigListScreen):
    ...
    def __init__(self, session, firstrun = False):
        ...
        self.pluglist = [['BhWeather', 'bhweather'],
         ...
         ['SH4BoosterControl', 'enigma2-plugin-systemplugins-sh4boostercontrol'],
         ['CommonInterfaceAssignment', 'enigma2-plugin-systemplugins-commoninterfaceassignment'],
         ['SH4OSDAdjustment', 'enigma2-plugin-systemplugins-sh4osdadjustment'],
         ['PicturePlayer', 'enigma2-plugin-extensions-pictureplayer'],
         ['YouTube', 'enigma2-plugin-extensions-youtube'],
         ['SparkVFDControl', 'enigma2-plugin-systemplugins-sparkvfdcontrol'],
         ...
         ['KeymapManager', 'enigma2-plugin-systemplugins-keymapmanager'],
         ...
         ['AlternativeSoftCamManager', 'enigma2-plugin-extensions-alternativesoftcammanager']]
